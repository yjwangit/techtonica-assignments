...
function exercise3(num3) {
  ...
  // --------------------------------------------
  if(num3>0){
      answer3 = num + " is positve";
  } else if(num3<0){
      answer3 = num + " is negative";
  } else {
      answer3 = num + " is zero";
  }
  // --------------------------------------------
...
//My analysis is that if varA is a boolean and varB is a string, although they look similar, they are not equal.
//i.e varA = true, varB = "true".
  ...
  // --------------------------------------------
    switch(num7){
      ...
      case 7:
        ...
        break;
      case 1000000:
        answer7 = "You are one in million!";
        break;
      default:
...
function exercise9(item) {
  ...
  if (typeof item ==="number"){
    ...
    answer9 = "Please send a number, thata was a "+typeof item+ "."
  }
  // --------------------------------------------
  // And above here
  // --------------------------------------------
